        ...
        <div className="hidden md:flex w-2/5 bg-gradient-to-br from-[#059669] to-[#047857] p-12 flex-col justify-center text-white">
          <div className="max-w-sm">
            ...
            <p className="text-green-100 leading-relaxed text-base">
              Connect with your team, manage orders, and build amazing dining experiences together.
            </p>
          </div>
        </div>
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <form onSubmit={handleLogin}>
              ...
              <div className="flex items-center justify-between mb-6 flex-wrap gap-2">
                ...
                <button type="button" onClick={() => navigate("/forget-password")} className="text-sm text-[#059669] hover:text-[#047857] font-medium">Forgot password?</button>
              </div>
            ...
            <p className="text-center text-sm text-gray-600">
              ...
              <button onClick={() => navigate("/register")} className="text-[#059669] hover:text-[#047857] font-semibold">Sign up</button>
            </p>
          </div>
        </div>
      </div>
